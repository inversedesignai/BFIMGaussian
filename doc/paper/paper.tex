...
We pursue this extension in a companion line of work, DADE (\emph{Differentiable Adaptive experimental Design Engine}), which targets real-time tracking of a nonlinear dynamical system with a jointly-designed physical sensor and a learned measurement policy; full treatment is deferred to that paper.  The present work establishes the static-state foundation on which that extension stands.
